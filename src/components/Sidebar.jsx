...
export default function Sidebar({ isOpen, toggleSidebar }) {
  ...
  const menuItems = [
    ...
    { path: "/templates", label: "View Templates", icon: "bi-columns" }, // ✔ Connected to CustomizeTemplates
    { path: "/templates", label: "Build Portfolio", icon: "bi-brush" },
    ...
    { path: "/ask-ai", label: "Smart Resume", icon: "bi-stars" },
